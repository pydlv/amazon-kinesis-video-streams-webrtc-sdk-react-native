...
var webcrypto_1 = tslib_1.__importDefault(require("@trust/webcrypto"));
/**
...
var SigV4RequestSigner = /** @class */ (function () {
    ...
    SigV4RequestSigner.sha256 = function (message) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, webcrypto_1.default.subtle.digest({ name: 'SHA-256' }, this.toUint8Array(message))];
                    case 1:
                        hashBuffer = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, webcrypto_1.default.subtle.importKey('raw', keyBuffer, {
                                name: 'HMAC',
                                hash: {
                                    name: 'SHA-256',
                                },
                    ...
                    case 1:
                        cryptoKey = _a.sent();
                        return [4 /*yield*/, webcrypto_1.default.subtle.sign('HMAC', cryptoKey, messageBuffer)];
